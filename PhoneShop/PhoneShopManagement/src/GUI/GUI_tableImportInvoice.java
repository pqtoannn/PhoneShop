...
public class GUI_tableImportInvoice extends javax.swing.JPanel {
    ...
    private BUS_ImportDetail bus_imdetail = new BUS_ImportDetail();
    ...
    private ArrayList<DTO_DefaultInvoice> matchingProducts = new ArrayList<DTO_DefaultInvoice>();
    
    int mouseClick = -1;
    

    
    public GUI_tableImportInvoice() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quản lý hóa đơn nhập kho");
    ...
    private void tbl_MainMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_MainMouseClicked
        ...
        Utils.selectedImport = list.get(tbl_Main.getSelectedRow());
        Utils.selectedImport.setDetails(bus_imdetail.getList());
        
        renderDetailTable(Utils.selectedImport.getDetails());
    ...
    private void btn_refreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_refreshActionPerformed
        txt_Search.setText("");
        txt_Date.setText("");
        txt_fromPrice.setText("");
        txt_toPrice.setText("");
        renderMainTable(list);
        renderDetailTable(listDetail);
        clear();
        ...
        */
        ...
        switch (cbx_Search.getSelectedIndex()) {
            case 1:
                ...
                list = bus_iminvoice.searchByInvoiceID(list, keyword);
            ...
            case 4:
                ...
                if (!fromPriceString.isEmpty() && !toPriceString.isEmpty()) {
                    ...
                    list = bus_iminvoice.searchByOrderPrice(list, fromPrice, toPrice);
                    searchNotification(list);
                }
                break;
            case 5:
                if (txt_Date.getText().toString().contains("to")) {
                    ...
                    list = bus_iminvoice.searchByInitDate(list, fromDate, toDate);
                    searchNotification(list);
                }
                break;
            default:
    ...
    private void sortASC() {
        ...
        */
        switch (cbx_Sort.getSelectedIndex()) {
            case 1:
                list = bus_iminvoice.sortByInitDateASC(list);
                renderMainTable(list);
                break;
            case 2:
                list = bus_iminvoice.sortByInvoicePriceASC(list);
                renderMainTable(list);
                break;
            case 3:
                list = bus_iminvoice.sortByInvoiceFullNameASC(list);
                renderMainTable(list);
                break;
            default:
        }
    ...
    private void sortDESC() {
        ...
        */
        switch (cbx_Sort.getSelectedIndex()) {
            case 1:
                list = bus_iminvoice.sortByInitDateDESC(list);
                renderMainTable(list);
                break;
            case 2:
                list = bus_iminvoice.sortByInvoicePriceDESC(list);
                renderMainTable(list);
                break;
            case 3:
                list = bus_iminvoice.sortByInvoiceFullNameDESC(list);
                renderMainTable(list);
                break;
            default:
        }
    ...
    private void printWord(XWPFDocument document) {
        ...
        run = paragraph.createRun();
        run.setFontSize(13);
        run.setText("Tên người tạo:  " + Utils.selectedImport.getUser().getFullname());
        run.setFontFamily("Times New Roman");
        paragraph = document.createParagraph();
        run = paragraph.createRun();
        run.setFontSize(13);
        run.setText("Số điện thoại:  " + Utils.selectedImport.getUser().getPhone());
        run.setFontFamily("Times New Roman");
        paragraph = document.createParagraph();
        run = paragraph.createRun();
        run.setFontSize(13);
        
        run.setText("Hoá đơn Ngày " + Utils.selectedImport.getInitdate().getDd() + " Tháng " + Utils.selectedImport.getInitdate().getMm()+ " Năm " + Utils.selectedImport.getInitdate().getYyyy());
        ...
        for (int i = 0; i < Utils.selectedImport.getDetails().size(); i++) {
            row = table.createRow();
            cell = row.getCell(0);
            paragraph = cell.getParagraphArray(0);
            run = paragraph.createRun();
            ...
            run.setFontFamily("Times New Roman");
            run.setFontSize(13);
            run.setText(Utils.selectedImport.getDetails().get(i).getOption().getProductname() + ", Rom: " + getUnit(Utils.selectedImport.getDetails().get(i).getOption().getRom()) + ", Ram: " + getUnit(Utils.selectedImport.getDetails().get(i).getOption().getRam()) + ", Màu: " + Utils.selectedImport.getDetails().get(i).getOption().getColor().getName());
            ...
            run.setFontFamily("Times New Roman");
            run.setFontSize(13);
            run.setText(Utils.selectedImport.getDetails().get(i).getQuantity() + "");
            ...
            run.setFontFamily("Times New Roman");
            run.setFontSize(13);
            run.setText(" " + decimalFormat.format(Utils.selectedImport.getDetails().get(i).getOption().getImportprice()) + "VNĐ");
            ...
            run.setFontFamily("Times New Roman");
            run.setFontSize(13);
            run.setText(" " +decimalFormat.format(Utils.selectedImport.getDetails().get(i).getTotalprice()) + "VNĐ");
        }
        row = table.createRow();
        ...
        run.setFontSize(13);
        run.setBold(true);
        run.setText(decimalFormat.format(Utils.selectedImport.getPrice()) + "VNĐ");
        
        paragraph = document.createParagraph();
        run = paragraph.createRun();
        String a = decimalFormat.format(Utils.selectedImport.getPrice());
