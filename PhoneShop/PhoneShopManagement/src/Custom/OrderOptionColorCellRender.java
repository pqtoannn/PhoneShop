...
public class OrderOptionColorCellRender extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        this.item = (DTO_Option) table.getValueAt(row, 8);
        String color = item.getColor().rgbToString();
