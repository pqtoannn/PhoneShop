...
public class OrderQuantityCellEditor extends DefaultCellEditor {
    ...
    public OrderQuantityCellEditor(EventSpinnerInputChange event) {
        super(new JCheckBox());
        this.event = event;
        input = new JSpinner();
    ...
    private void inputChange() {
        ...
        if (quantity != item.getQuantity()) {
            ...
            table.setValueAt(df.format(item.getTotalprice()), row, 6);
            event.inputChanged();
        }
    }
}
