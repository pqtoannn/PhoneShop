...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("assets/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("assets/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("assets/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("assets/light.svg"));
        }
    }
