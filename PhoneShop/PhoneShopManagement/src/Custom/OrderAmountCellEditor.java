...
public class OrderAmountCellEditor extends DefaultCellEditor {
    ...
    public OrderAmountCellEditor(EventSpinnerInputChange event) {
        super(new JCheckBox());
        this.event = event;
        input = new JSpinner();
    ...
    private void inputChange() {
        ...
        if (amount != item.getQuantity()) {
            ...
            table.setValueAt(df.format(item.getTotalprice()), row, 5);
            event.inputChanged();
        }
    }
}
