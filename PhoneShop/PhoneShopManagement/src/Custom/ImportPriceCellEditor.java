...
public class ImportPriceCellEditor extends DefaultCellEditor {
    ...
    public ImportPriceCellEditor(EventTextFieldInputChange eChange) {
        super(new JCheckBox());
        this.event = eChange;
