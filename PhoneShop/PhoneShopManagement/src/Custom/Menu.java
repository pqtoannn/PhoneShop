...
import Custom.mode.LightDarkMode;
...
import Custom.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    private final String menuItems[][] = {
        {"~QUAN TRỌNG~"},
        {"Sản phẩm", "Điện thoại", "Phiếu bảo hành"},
        {"Người dùng", "Tài khoản", "Đơn đặt hàng"},
        {"Kho hàng", "Nhập kho", "Xuất kho"},
        {"~KHÁC~"},
        {"Thống kê", "Tình hình kinh doanh", "Doanh số bán hàng"},
        {"Đăng xuất"}
    };
    ...
    private void init() {
        ...
        //header.setIcon(new ImageIcon(getClass().getResource("/assets/smartphone.png")));
        
        ImageIcon imgicon = new ImageIcon(getClass().getResource("/assets/mobile_shop.png"));
        Image img = imgicon.getImage();
        Image newimg = img.getScaledInstance(42, 42, Image.SCALE_SMOOTH);
        ImageIcon reimg = new ImageIcon(newimg);
        header.setIcon(reimg);
