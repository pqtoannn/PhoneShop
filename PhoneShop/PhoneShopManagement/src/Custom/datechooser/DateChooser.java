...
import Custom.datechooser.layout.CellLayout;
import Custom.datechooser.layout.HeaderLayout;
import Custom.datechooser.listener.DateChooserAction;
import Custom.datechooser.listener.DateChooserListener;
import Custom.datechooser.render.DateChooserRender;
import Custom.datechooser.render.DefaultDateChooserRender;
...
public class DateChooser extends JPanel {
    ...
    private void createHeader() {
        ...
        panelHeader.putClientProperty(FlatClientProperties.STYLE, "" +
                "background:if($DateChooser.background,$DateChooser.background,$Panel.background)");
        JButton cmdBack = new JButton(new FlatSVGIcon("assets/arrowCollapse.svg"));
        JButton cmdNext = new JButton(new FlatSVGIcon("assets/arrowExpand.svg"));
